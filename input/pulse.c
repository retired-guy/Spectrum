...
void getPulseDefaultSink(void *data) {
    ...
    pulseaudio_context = pa_context_new(mainloop_api, "spectrum device list");
...
void *input_pulse(void *data) {
    ...
    if (!(s = pa_simple_new(NULL, "spectrum", PA_STREAM_RECORD, audio->source, "audio for spectrum", &ss,
                            NULL, &pb, &error))) {
